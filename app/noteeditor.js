...
for(var i = 0; i < list_of_links.length; i++) {
  ...
  if(resource == "Wikipedia") {
    ...
    html += "<div class='note-header'><b>" + element.dataset.title + "</b>";
    html += "<br><br><a href='"+url+"' target='_blank'>"+"Wikipedia Page"+"</a></div>";
    html += "</div>";
    ...
    html += "<div class='note-header'><b>" + element.dataset.title + "</b>";
    if(element.dataset.source != null) {
      html += "<br><br><a href='"+url+"' target='_blank'>"+element.dataset.source+"</a>";
    } else {
      html += "<br><br><a href='"+url+"' target='_blank'>"+"External Link"+"</a>";
    }
    html += "</div></div>";
